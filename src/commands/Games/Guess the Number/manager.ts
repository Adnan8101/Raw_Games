...
export class GuessTheNumberManager {
    private static instance: GuessTheNumberManager;
    ...
    public static getInstance(client: Client): GuessTheNumberManager {
        if (!GuessTheNumberManager.instance) {
            GuessTheNumberManager.instance = new GuessTheNumberManager(client);
        }
        return GuessTheNumberManager.instance;
    }
